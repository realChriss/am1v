...
export function BitcoinIcon({ className }: IconProps) {
  return (
    <svg viewBox="3.61 3.45 16.66 16.66" fill="currentColor" className={className} aria-hidden="true">
...
export function VexWaveIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 21.7" fill="currentColor" className={className} aria-hidden="true">
...
export function E2ShareIcon({ className }: IconProps) {
  return (
    <svg viewBox="5.44 5.44 13.12 13.12" fill="currentColor" className={className} aria-hidden="true">
      <path
        fillRule="evenodd"
...
export function PlasmerIcon({ className }: IconProps) {
  return (
    <svg viewBox="8.5 8.5 239 239" fill="currentColor" className={className} aria-hidden="true">
